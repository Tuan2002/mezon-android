...
class WebhookChannelPicker(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val list = RecyclerListView(context).apply {
            ...
            adapter = this@WebhookChannelPicker.adapter
    ...
    private inner class ChannelRowsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            ...
            val row = LinearLayout(ctx).apply {
                ...
                layoutParams = RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LayoutHelper.WRAP_CONTENT).apply {
